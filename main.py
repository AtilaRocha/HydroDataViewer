from src.function import saveXML, convertXMLtoCSV, convertXMLtoXLSX, verificar_pasta
import os
...
convert = input("Deseja converter o XML para CSV/XLSX? Digite 'todos' para converter todos ou 'y' para converter individualmente: ")
if convert.lower() == 'todos':
